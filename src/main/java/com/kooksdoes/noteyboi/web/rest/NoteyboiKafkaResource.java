...
@RestController
@RequestMapping("/api/noteyboi-kafka")
public class NoteyboiKafkaResource {
    private final Logger log = LoggerFactory.getLogger(NoteyboiKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NoteyboiKafkaResource(KafkaProperties kafkaProperties) {
